...
<<mymatlab, engine="matlab", engine.path="C:/Program Files/MATLAB/R2015a/bin/matlab.exe", engine.opts="-nosplash -nodesktop -minimize", echo=TRUE, eval=TRUE, tidy=TRUE, cache=FALSE, background="#ffffff">>=
...
We used 
\begin{itemize}
 \item RStudio Version 0.99.441 - \copyright \ 2009-2015 RStudio, Inc.
 \item pdfTeX, Version 3.1415926-2.4-1.40.13 (MiKTeX 2.9)
\end{itemize}
